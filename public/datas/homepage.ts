...
export const footerData = {
  contact: {
    phone: "+(1) 000 123 456 789",
    email: "info@example.com",
    address: "No: 58 A, East Madison Street, Baltimore, MD, USA 4508",
  },
  socials: [
    { name: "facebook", href: socialLinks.facebook, icon: "fb" },
    { name: "instagram", href: socialLinks.instagram, icon: "insta" },
    { name: "tiktok", href: socialLinks.tiktok, icon: "tiktok" },
  ],
  center: {
    logo: "LILAC",
    description: "Rorem ipsum sit amet, sed do eiusmod ut labore et dolore magna aliqua. Risus commodo viverra maecenas accumsan lacus vel facilisis.",
    links: [
      { name: "Home", href: "/" },
      { name: "Shop", href: "/shop" },
  ...
  newsletter: {
    description: "Sorem ipsum dolor sit amet, consectetur adipiscing elit, eiusmod aliqua.",
  },
};
...
export const statsData = {
  ...
  title: "Lightweight Cosmetics",
  description: "Vel quam elementum pulvinar etiam non quam lacus suspendisse. Rutrum quisque non tellus orci ac auctor. Volutpat est velit egestas dui id ornare arcu odio.",
  stats: [
    { label: "Products Sold", value: 4300, suffix: "K" },
    { label: "Chemical-Free", value: 99.99, suffix: "%" },
    { label: "Satisfied Customers", value: 42, suffix: "K" },
    { label: "Defective Returns", value: 0.01, suffix: "%" },
  ],
};
